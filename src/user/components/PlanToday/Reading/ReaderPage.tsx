...
import { Back, BookList, Complete, Congratulate, EmptyBook, ErrBook, Further, GoPage } from '../../../../shared/constants/textConsts'
  ...
  return (
    <Box
      ...
      <iframe
        ...
        style={{ width: '100%', height: '75vh', border: '1px solid #ccc', borderRadius: 8, overflowY: 'hidden', background: '#F5F5F5'}}
      />
      ...
      <Dialog open={isCongratsOpen} onClose={closeCongrats}>
        ...
        <DialogActions>
          <Button onClick={() => {navigate(-1)}}>{BookList}</Button>
        </DialogActions>
      </Dialog>
    </Box>
  )

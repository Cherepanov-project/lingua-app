...
import { audio, listeningSkillsPageStack, selectAudio } from './listeningConst.ts'
import { useGetListeningExercisesQuery } from '../../../../shared/api/listeningApi.ts'
import type { FetchBaseQueryError } from '@reduxjs/toolkit/query/react'
import { ListeningLayout } from './ListeningLauout.tsx'
...
export const ListeningSkillsPage = () => {
  ...
  return (
    <ListeningLayout>
      <Stack sx={listeningSkillsPageStack}>
        <Typography variant="h4" sx={{ marginBottom: '10px' }}>
          {audio}
        </Typography>
        <Typography sx={{ fontSize: '24px', marginBottom: '20px' }}>{selectAudio}</Typography>

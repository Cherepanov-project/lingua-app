/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f4dbbbaf77c350454a0d5d10a38d2f65)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_AUTH0_CLIENT_ID_SPA: string;
		VITE_AUTH0_CLIENT_SECRET_SPA: string;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
